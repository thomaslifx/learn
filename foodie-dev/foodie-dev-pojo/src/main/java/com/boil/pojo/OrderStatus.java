...
public class OrderStatus {
     ...
     * 发货时间
     */
    @Column(name = "dellyer_time")
    private Date dellyerTime;
     ...
     * 获取发货时间
     *
     * @return dellyer_time - 发货时间
     */
    public Date getDellyerTime() {
        return dellyerTime;
    }
     ...
     * 设置发货时间
     *
     * @param dellyerTime 发货时间
     */
    public void setDellyerTime(Date dellyerTime) {
        this.dellyerTime = dellyerTime;
    }
